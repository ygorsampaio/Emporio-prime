...
const CATEGORY_META: Record<CategoryFilter, { title: string; desc: string }> = {
  ...
  temperos:     { title: 'Temperos',          desc: 'Temperos artesanais Empório Prime — sabor e qualidade em cada sachê.' },
...
export default function ProductGrid({ products }: ProductGridProps) {
  ...
  return (
    <>
      ...
      <section id="catalogo" className="max-w-6xl mx-auto px-4 lg:px-10 py-10">
        {/* Header */}
        <div className="flex items-end justify-between gap-4 mb-8 flex-wrap">
          <div>
            <h2 className="font-display text-2xl lg:text-3xl font-bold text-gray-900">{meta.title}</h2>
        ...
        {/* Grid — 2 colunas mobile, 3 tablet, 4 desktop, 5 em telas grandes */}
